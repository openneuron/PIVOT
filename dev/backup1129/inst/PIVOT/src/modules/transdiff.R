        ...
        fluidRow(
            column(12, 
                   ...
                   enhanced_box(
                       ...
                       fluidRow(
                           column(12, 
                                  tags$b("Top Ranked TFs in Neuron"),
                       ...
                       fluidRow(
                           column(12, 
                                  tags$b("Top Ranked TFs in Cardiomyocytes"),
...
output$tf_net_all <- renderPlot({
    ...
    if(input$tf_net_add_label) {
        ...
        legend("bottom", c(paste("Upregulated in Neuron"), paste("Upregulated in Cardiomyocytes")), # Double check the direction
