...
observeEvent(input$submit_single, {
    ...
    withProgress(message = 'Processing', value = 0, {
        ...
        r_data <- update_history(r_data, NA, "Input", "Input count table", list(feature = r_data$feature_list, sample = r_data$sample_name), r_data$norm_param$method, r_data$norm_param)
